    ...
    >
      <Descriptions size="small" column={1}>
        ...
        <Descriptions.Item label="Component">
          <Typography.Link href={paths.metabase.component(data.componentId)}>
            {data.componentId}
          </Typography.Link>
        </Descriptions.Item>
        ...
        <Descriptions.Item label="Root Resource">
          <Typography.Link href={data.resourceTree.root.value.locator}>
            {data.resourceTree.root.value.uuid}
          </Typography.Link>
        </Descriptions.Item>
        {data.userId != null && (
          <Descriptions.Item label="User">
            <Typography.Link href={paths.metabase.user(data.userId)}>
              {data.userId}
            </Typography.Link>
          </Descriptions.Item>
        )}
